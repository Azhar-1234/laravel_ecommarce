...
<html lang="en">
  <head>
    <title>@yield('title', 'FoodMart - Free eCommerce Grocery Store')</title>
    <meta charset="utf-8">
    ...
    <div class="offcanvas offcanvas-end" data-bs-scroll="true" tabindex="-1" id="offcanvasCart" aria-labelledby="My Cart">
      ...
      <div class="offcanvas-body">
        <div class="order-md-last">
          ...
          <a href="{{ route('cart.index') }}" class="w-100 btn btn-primary btn-lg mt-3">View Cart</a>
        </div>
      </div>
    </div>
                ...
                data.items.forEach(function(item) {
                    cartItemsHtml += `
                        <div class="list-group-item d-flex justify-content-between lh-sm">
                            ...
                            <span class="text-body-secondary">$${parseFloat(item.total).toFixed(2)}</span>
                        </div>
                    `;
                });
            } else {
